...
public class PriorityApiController implements PriorityApi {
    ...
    public PriorityApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Void> addPriority(@ApiParam(value = "Priority object that needs to be added to the database" ,required=true )  @Valid @RequestBody Priority body) {
